...
function under50PriceFilterFunction(data) {
  let newArr = data.filter(function (item) {
    if (
      under50PriceFilter.innerText == "₹150 and Under" &&
      item.price <= 150.0
    ) {
      specialSortValueDisplay("₹150 and Under");
      return item.price;
    }
  });
  displayData(newArr);
...
function HundredAndUnderPriceFilterFunction(data) {
  let newArr = data.filter(function (item) {
    if (
      HundredAndUnderPriceFilter.innerText == "₹300 and Under" &&
      item.price <= 300
    ) {
      specialSortValueDisplay("₹300 and Under");
      return item.price;
    }
  });
  displayData(newArr);
...
function twoHundredAndUnderPriceFilterFunction(data) {
  let newArr = data.filter(function (item) {
    if (
      twoHundredAndUnderPriceFilter.innerText == "₹500 and Under" &&
      item.price <= 500
    ) {
      specialSortValueDisplay("₹500 and Under");
      return item.price;
    }
  });
  displayData(newArr);
...
function twoHundredAndOverPriceFilterFunction(data) {
  let newArr = data.filter(function (item) {
    if (
      twoHundredAndOverPriceFilter.innerText == "₹500 and Over" &&
      item.price >=500.0
    ) {
      specialSortValueDisplay("₹500 and Over");
      return item.price;
    }
  });
  displayData(newArr);
